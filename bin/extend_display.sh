...
# extend non-HiDPI external display on DP* right-of HiDPI internal display eDP*
xrandr --output "${INT}" --auto --scale 1x1 --pos 0x0 --output "${EXT}" --auto --pos ${int_w}x0 --scale 2x2 
